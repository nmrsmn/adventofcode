...
class Day2Tests: PuzzleTest
{
    ...
    private val input = listOf(
        puzzle.parsePasswordLine("1-3 a: abcde"),
        puzzle.parsePasswordLine("1-3 b: cdefg"),
        puzzle.parsePasswordLine("2-9 c: ccccccccc"))
    ...
    */
    ...
    override fun `part one examples`()
    {
        Assertions.assertEquals(2,
            puzzle.validatePasswordLinesByCount(input))
    }
    ...
    */
    ...
    override fun `part two examples`()
    {
        Assertions.assertEquals(1,
            puzzle.validatePasswordLinesByIndex(input))
    }
}